...
import info.saberlion.Models.*;


public class V2exNetwork {

    public static String hotnews_url = "http://www.v2ex.com/api/topics/hot.json";
    public static String fastnews_url = "http://www.v2ex.com/api/topics/latest.json";
    public static String profile_url = "http://www.v2ex.com/api/members/show.json";
